    ...
    $scope.trips = [
        {
            ...
            "team": [
                {"name": "Brandon Clark", "role": "Student"},
                {"name": "Evelyn Grainger", "role": "Student"},
                {"name": "Sienna Mayer", "role": "Student"},
                {"name": "Karen Orton", "role": "Student"},
                {"name": "Aaron Pepin", "role": "Student"},
                {"name": "Lenna Quackenbush", "role": "Student"},
                {"name": "Laureen Elgert", "role": "Professional"},
                {"name": "Rodney Rookey", "role": "Professional"}]
        },
		{
        ...
        "team": [
                {"name": "Jessie Ciulla", "role": "Student"},
                {"name": "Amanda Gatz", "role": "Student"},
                {"name": "Nikos Kalaitzidis", "role": "Student"},
                {"name": "Aaron Pepin", "role": "Student"},
                {"name": "Katie Picchione", "role": "Student"},
                {"name": "Daniel Singer", "role": "Student"},
                {"name": "Rodney Rookey", "role": "Professional"},
                {"name": "Patricia Stapleton", "role": "Professional"}]
        },
        {
        ...
        "team": [
                {"name": "Jessie Ciulla", "role": "Student"},
                {"name": "Camden Knoff", "role": "Student"},
                {"name": "Thomas Moutinho", "role": "Student"},
                {"name": "Rita Newman", "role": "Student"},
                {"name": "Aaron Pepin", "role": "Student"},
                {"name": "Katie Picchione", "role": "Student"},
                {"name": "Laureen Elgert", "role": "Professional"},
                {"name": "Michael Reiter", "role": "Professional"}]
        },
        {
        ...
        "team": [
                {"name": "Michele Mensing", "role": "Student"},
                {"name": "Thomas Moutinho", "role": "Student"},
                {"name": "Katie Picchione", "role": "Student"},
                {"name": "Tome Washburn", "role": "Student"},
                {"name": "Patricia Austin", "role": "Professional"},
                {"name": "Michael Reiter", "role": "Professional"}]
        },
        {
        ...
        "team": [
                {"name": "Jessie Ciulla", "role": "Student"},
                {"name": "Caryn McDonalid", "role": "Student"},
                {"name": "Tom Moutinho", "role": "Student"},
                {"name": "Sebastian Vergara", "role": "Student"},
                {"name": "Robert Hersh", "role": "Professional"}]
        },
        {
        ...
        "team": [
                {"name": "Jennifer Moutinho", "role": "Student"},
                {"name": "Tom Moutinho", "role": "Student"},
                {"name": "Laura Pumphrey", "role": "Student"},
                {"name": "Chris Sontag", "role": "Student"},
                {"name": "Lexa Vresilovic", "role": "Student"}]
        },
        {
        ...
        "team": [
                {"name": "Julie Bliss", "role": "Student"},
                {"name": "Christopher Garceau", "role": "Student"},
                {"name": "Kali Manning", "role": "Student"},
                {"name": "Emily McWilliam", "role": "Student"},
                {"name": "Alberto Phillips", "role": "Student"},
                {"name": "Lexa Vresilovic", "role": "Student"},
                {"name": "Matthew Gamanche", "role": "Professional"},
                {"name": "Creighton Peet", "role": "Professional"}]
        },
        {
        ...
        "team": [
                {"name": "Julie Bliss", "role": "Student"},
                {"name": "Christopher Garceau", "role": "Student"},
                {"name": "Maria Alexandra Rangel", "role": "Student"},
                {"name": "Daniel Warfel", "role": "Student"},
                {"name": "Matthew Gamanche", "role": "Professional"},
                {"name": "Creighton Peet", "role": "Professional"}]
        }
    ];
